...
let posicoes = []; 
let correndo = false; // não deixa clicar 2x

const TOTAL_VOLTAS = 10;

function iniciarCorrida() {
    // bloqueia interações enquanto estiver correndo
    if (correndo) return;
    correndo = true;
    ...
    // deixa o botão inativo
    const btn = document.getElementById('btnCorrer');
    btn.disabled = true;
    btn.textContent = 'Correndo...';

    // Começa com todos os pilotos da forma que foram setados na array
    posicoes = [...corredores];
    ...
    // intervalo para mudar o grid
    const intervalo = setInterval(function () {

        // muda a ordem dos pilotos baseado no peso
        ...
        // Modifica a barra de andamento da corrida
        ...
        posicoes.slice(0, 8).forEach(function (nome, i) {
            ...
            `;
            // adiciona elemento dentro de outro elemento 
