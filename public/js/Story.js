...
function conteudo() {
    ...
    if(imagem == 2) {
        textoM.innerHTML = `<div class="text">
            <h4>Como surgiu meu interesse pelo tema?</h4>
            <div class="conteudo-flex">
                <p>Meu interesse por Fórmula 1 surgiu ainda na infância, entre 2011 e 2012. 
                ...
                Naquela época, meus pais estavam construindo nossa casa, porque ainda morávamos na casa dos meus avós.</p>
                <img src="./assets/imgs/WhatsApp Image 2026-05-18 at 23.26.54.jpeg">
            </div>
        </div>`;
    } else if (imagem == 3) {
        textoM.innerHTML = `<div class="text"><h4>Como surgiu meu interesse pelo tema?</h4>
        <div class="conteudo-flex">
            <p>Durante essa fase, nosso vizinho acabou se tornando muito amigo do meu pai, e consequentemente o filho dele virou meu amigo também. 
        ...
        <h4>Como surgiu meu interesse pelo tema?</h4>
        <div class="conteudo-flex">
            <p>Desde pequeno, sempre fui apaixonado por duas coisas: tecnologia e automobilismo. 
         ...
         <h4>Como surgiu meu interesse pelo tema?</h4>
         <div class="conteudo-flex">
            <p>Meu gosto pelo automobilismo também aparecia em vários momentos da minha vida. Tive festa de aniversário com tema de corrida, 
        ...
        textoM.innerHTML = `<div class="text">
        <h4>Como esse tema está presente no meu dia a dia?</h4>
        <div class="conteudo-flex">
            <p>Hoje em dia, o automobilismo continua sendo algo muito presente na minha vida. 
        ...
        como análise de dados, desempenho dos carros, estratégias e engenharia.
            <br><br>
            Esse interesse também se conecta diretamente com minha área de estudos em tecnologia. 
        Por isso escolhi esse tema para meu projeto individual: ele une algo que sempre fez parte da minha história com algo que quero seguir profissionalmente.
            </p>
        </div>
    </div>`
    } else if (imagem == 7) {
         textoM.innerHTML = `<div class="text">
         <h4>Valores representados no projeto</h4>
         <div class="conteudo-flex">
            <p>Meu projeto representa vários valores importantes para mim:
            ...
            Paixão por tecnologia, principalmente pela análise de dados e desempenho presente na Fórmula 1.
            </p>
        </div>
    </div>`
    } else if (imagem == 8) {
         textoM.innerHTML = `<div class="text">
         <h4>Momentos marcantes que reforçaram essa paixão</h4>
         <div class="conteudo-flex">
            <p>Mesmo sem nunca ter corrido de kart quando era criança, 
            eu sempre acompanhava vídeos e aprendia sobre pilotagem. 
            Isso fez diferença quando finalmente tive a oportunidade de correr.
            <br><br>
            Na minha festa de 13 anos, 
            ...
            e consegui garantir a vitória.
            <br><br>
            Outro momento muito importante aconteceu no ano passado, 
            ...
            Apesar disso, saí extremamente feliz porque alguns pilotos profissionais elogiaram meu desempenho e disseram que eu tinha potencial.
            <br><br>
            Também lembro com carinho da moto do meu pai, a Honda CB 300, 
         ...
         textoM.innerHTML = `<div class="text">
         <h4>Maior dificuldade no projeto</h4>
         <div class="conteudo-flex">
            <p>
            </p>
        </div>
         ...
         textoM.innerHTML = `<div class="text">
         <h4>Maior superação</h4>
         <div class="conteudo-flex">
            <p>Minha maior superação foi conseguir unir minhas duas maiores paixões: tecnologia e automobilismo. 
            Mais do que apenas criar um site, 
            consegui desenvolver algo que representa minha história, 
            minhas memórias e os momentos que vivi com minha família.
            </p>
        </div>
    </div>`
    } else if (imagem == 11) {
         ...
         <div class="conteudo-flex">
            <p>Grande parte dessa paixão surgiu por causa do meu pai. 
            ...
            então esse projeto também representa uma homenagem a tudo que vivi ao lado dele.
            </p>
         </div>
        </div>`
    }
